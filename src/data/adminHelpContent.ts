    ...
    topics: [
      {
        ...
        whatItDoes: "Beszállítói számlák fotózott képeiből az AI automatikusan kiolvassa a partnert, dátumokat, összegeket, ÁFA kulcsot és a látható tételsorokat.",
        howToUse: [
          "Számlák → 'Új bizonylat' → készíts fotót vagy tölts fel képet a számláról.",
          "Kattints az 'AI kitöltés' gombra. Fotózott számláknál működik a legjobban; PDF felismerés későbbi fejlesztés.",
          "Az AI kitölti a mezőket és a látható tételsorokat is szerkeszthető sorokként betölti.",
          "Mentés előtt mindig ellenőrizd az összeget, ÁFA kulcsot, dátumokat és a tételsorokat.",
