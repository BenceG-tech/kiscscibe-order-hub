    ...
    topics: [
      {
        ...
        whatItDoes: "Beszállítói számlák fotóiból, képfájljaiból és digitális PDF számlákból az AI automatikusan kiolvassa a partnert, dátumokat, összegeket, ÁFA kulcsot és a biztosan felismerhető tételsorokat.",
        howToUse: [
          "Számlák → 'Új bizonylat' → készíts fotót, tölts fel képet vagy digitális PDF számlát.",
          "Feltöltés után az adatkinyerés automatikusan elindul, külön AI gombot nem kell keresni.",
          "Digitális PDF-nél a rendszer először szöveget olvas; szkennelt PDF-nél az első oldalt képként próbálja felismerni.",
          "Az AI csak a biztos mezőket tölti ki, a bizonytalan adatokat üresen hagyja és a panelben jelzi kézi ellenőrzésre.",
          "A biztos tételsorokat szerkeszthető sorokként betölti, alacsony biztosságnál inkább nem tölti be automatikusan.",
          "Mentés előtt mindig ellenőrizd az összeget, ÁFA kulcsot, dátumokat, partnert és a tételsorokat.",
      ...
      {
        id: "invoice-test-records",
        pageGroup: "invoices",
        title: "Teszt számlák és próbarendelések kezelése",
        routes: ["/admin/invoices"],
        whatItDoes: "A próbaadatokat nem kell végleg törölni: tesztként jelölhetők, így nem számítanak bele az összesítőkbe és exportokba.",
        howToUse: [
          "A számlalistában a 3 pontos menüben válaszd a 'Tesztként jelölés' műveletet.",
          "A teszt rekordok alapból rejtve vannak a riportokból és ÁFA exportból.",
          "Ha látni akarod őket, kapcsold be a 'Teszt rekordok' gyors szűrőt.",
          "Automatikus rendelés-bizonylatnál inkább tesztként jelölj vagy sztornózz, ne törölj vakon.",
        ],
        whyItHelps: "A Bence Gatai jellegű próbarendelések nem torzítják a pénzügyi eredményt, mégis visszakereshetők maradnak.",
      },
      {
