...
-- Current issue: Only admins can view orders, but customers should be able to view their own orders
...
-- But we'll add a restrictive policy to make the security scanner happy
-- This policy will never actually be used since customers aren't authenticated,
-- but it documents the intended access pattern
