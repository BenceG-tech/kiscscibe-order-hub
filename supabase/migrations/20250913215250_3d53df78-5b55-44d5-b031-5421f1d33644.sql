...
-- 11. Secure settings table (remove public read access)
...
-- 12. Insert default admin user (this will need to be updated with actual admin email)
-- Note: This is a placeholder - in production, the first admin should be created manually